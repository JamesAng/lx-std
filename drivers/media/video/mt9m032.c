...
static int __init mt9m032_mod_init(void)
{
	return i2c_add_driver(&mt9m032_i2c_driver);
}

static void __exit mt9m032_mod_exit(void)
{
	i2c_del_driver(&mt9m032_i2c_driver);
}

module_init(mt9m032_mod_init);
module_exit(mt9m032_mod_exit);
