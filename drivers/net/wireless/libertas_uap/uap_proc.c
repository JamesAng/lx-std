...
#else
    /*
     * John O'Donnell (unixjohn1969@gmail.com) 11/08/2010
     * Had to modify the multicast count and list routines to conform with
     * with the 2.6.36 kernel methods. zamek@vili.pmmf.hu said it's really 2.6.34
     */
